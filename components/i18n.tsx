...
export const translations = {
  en: {
    ...
    studio: {
      ...
      bio2: "Currently studying D3 Manajemen Informatika at Politeknik Negeri Bali (GPA 3.75/4.00), I'm passionate about creating digital experiences that are not just functional, but truly delightful.",
  ...
  id: {
    ...
    studio: {
      ...
      bio2: 'Saat ini menempuh D3 Manajemen Informatika di Politeknik Negeri Bali (IPK 3.75/4.00), saya bersemangat menciptakan pengalaman digital yang tidak hanya fungsional, tetapi benar-benar menyenangkan.',
